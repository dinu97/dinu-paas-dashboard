...
class card extends HTMLElement {
    connectedCallback() {
      this.innerHTML = `
        ...
        <!--    Form Start    -->
    <div id="payment-stripe" class="container mt-4 d-flex justify-content-center main">
                                ...
                                <form name="cardForm" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-md-6  mb-2 pb-2">
                                            <div class="form-group">
                                                <label class="card-formMain-form-label"
                                                for="ExpirationDate">Expiration</label>
                                                <input id="cc-exp" type="tel" maxlength="7" class="input-lg form-control cc-exp" autocomplete="cc-exp" placeholder="•• / ••••" data-payment='cc-exp' required>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-6  mb-2 pb-2">
                                            <div class="form-group">
                                    ...
                                    <div class="col-6 col-md-12  mb-2 pb-2 ">
                                        <label class="card-formMain-form-label " for="TypeofBankAccount">Account
                                            Type</label>
                                        <select id="country" class="select form-control-lg w-100 select-country input-cardDetails" required>
                                    ...
                                    <div class="d-flex justify-content-center mt-3">
                                        <button id="validate" type="button" class="btn btn-info btn-rounded btn-lg w-100">Confirm Payment</button>
                                    </div>
                                </form>
                            </div>
                        </div>
